    ...
    <div className="w-full max-w-3xl mx-auto px-6">
      <div className="glass-card rounded-sm p-8 font-mono text-xs overflow-hidden relative min-h-[300px]">
        <div className="absolute top-4 left-4 flex gap-2 mb-8">
          ...
          <div className="w-2 h-2 rounded-full bg-astra-purple/50" />
        </div>
        ...
        <div className="mt-8 space-y-4" ref={containerRef}>
          <AnimatePresence mode="popLayout">
            {visibleLogs.map((log, i) => (
              ...
              >
                <span className="text-[10px] font-black uppercase tracking-tighter text-astra-purple shrink-0 min-w-[80px]">
                  {log.label}
                </span>
        ...
        <div className="absolute bottom-4 left-8 right-8 flex items-center gap-4">
          ...
          <div className="text-[8px] font-black uppercase tracking-[0.5em] text-astra-purple animate-pulse">
